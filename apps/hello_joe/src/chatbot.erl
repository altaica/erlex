...
%%% the bot will send a greeting <code>{hello, Pid}</code> to the new caller.
%%%
...
%%      returning the Pid of the client bot and a list of the current conference participants.
%% @end
